        ...
        <div class="section-body">
            <div class="row">
                ...
                <div class="col-md">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4">Detail Penarikan Dana Anggaran</h6>
                                    ...
                                    <tbody>
                                        @foreach ($item->details as $detail)
                                            <tr>
                                                ...
                                                <td>Rp {{ number_format($detail->target_belanja, 0, '.', '.') }}</td>
                                                <td>Rp {{ number_format($detail->realisasi_belanja, 0, '.', '.') }}</td>
                                            </tr>
                                        @endforeach
                                    </tbody>
                                </table>
