...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Data Target PBJ</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item active"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item">Data Target PBJ</div>
            </div>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (auth()->user()->role === 'skpd')
                                <a href="{{ route('target-pbjs.create') }}" class="btn btn-sm btn-primary mb-3"><i
