        ...
        <div class="section-body">
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4">Realisasi PBJ</h6>
                            <ul class="list-inline">
                                <li class="list-inline-item d-flex mb-2 justify-content-between">
                                    <span class="font-weight-bold">Tahapan</span>
                                    <span>{{ $item->tahapan }}</span>
                                </li>
                                <li class="list-inline-item d-flex mb-2 justify-content-between">
                ...
                <div class="col-md">
                    <div class="card">
                        <div class="card-body">
                            <h6 class="mb-4">Detail Realisasi PBJ</h6>
