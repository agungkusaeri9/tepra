...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Edit Realisasi PBJ</h1>
            <div class="section-header-breadcrumb">
                <div class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></div>
                <div class="breadcrumb-item active"><a href="{{ route('realisasi-pbjs.index') }}">Realisasi PBJ</a>
                </div>
                <div class="breadcrumb-item">Edit Realisasi PBJ</div>
            </div>
        </div>
        <div class="section-body">
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('realisasi-pbjs.update', $item->id) }}" method="post"
                                class="needs-validation" novalidate="">
                                @csrf
                                @method('patch')
                                <div class='form-group mb-3'>
                                    <label for='tahapan' class='mb-2'>Tahapan</label>
                                    <input type='text' name='tahapan'
                                        class='form-control @error('tahapan') is-invalid @enderror'
                                        value='{{ $item->tahapan ?? old('tahapan') }}'>
                                    @error('tahapan')
